...
@RequestMapping(value="/tasks/archive/{taskIds}",method = RequestMethod.POST,headers="Accept=application/json")
  ...
  @RequestMapping(value="/tasks/insert/{eventname}/{description}/{idevent}/{country}",method = RequestMethod.POST,headers="Accept=application/json")
  public List<Task> addTask(@PathVariable String eventname,@PathVariable String description,@PathVariable int idevent,@PathVariable String country) throws ParseException { 
  Task task = new Task();
